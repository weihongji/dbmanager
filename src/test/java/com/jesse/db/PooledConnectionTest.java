...
public class PooledConnectionTest {
	...
	public void testToString() {
		...
		assertEquals("#0: Available, created at: " + connection.getDateStamp().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + ", usage: 0", connection.toString());
	}
	...
	public void testToString1() {
		...
		try {
			Field createTimeField = PooledConnection.class.getDeclaredField("dateStamp");
		...
		assertEquals("#0: Available, created at: " + created.format(DateTimeFormatter.ofPattern("MMM d HH:mm:ss")) + ", usage: 0", connection.toString());
	}
	...
	public void testToString2() {
		...
		assertEquals("#0: Available, created at: 09:21:34, last used: 10:21:34, usage: 2", connection.toString());
	}
	...
	public void testToString3() {
		...
		// Engaged, created at: Feb 11 01:02:03, last used: 00:08:00, usage: 109
		assertEquals("#0: Engaged, created at: " + created.format(DateTimeFormatter.ofPattern("MMM d")) + " 01:02:03, last used: 00:08:00, usage: 109", connection.toString());
	}
	...
	public void testToString4() {
		...
		assertEquals("#0: Engaged, created at: " + created.format(DateTimeFormatter.ofPattern("MMM d")) + " 01:02:03, last used: " + lastUsed.format(DateTimeFormatter.ofPattern("MMM d")) + " 00:08:00, usage: 109", connection.toString());
	}
}